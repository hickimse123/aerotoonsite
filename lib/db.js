...
const SCHEMA_VERSION = 5; // v5: external_url/external_note migrationı fonksiyonun en başına taşındı (bkz. migrateDatabase üstündeki not) — v4'te bir sonraki adımlardan biri sessizce patladığı için bu koda hiç ulaşılamamıştı
